...
#define LCM_DBG(fmt, arg...) \
    LCM_PRINT("LCM [ili9881c_hlt] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)
// ---------------------------------------------------------------------------
//  Local Variables
// ---------------------------------------------------------------------------
...
static struct LCM_setting_table lcm_initialization_setting_v2[] = 
{
    ...
    {0xFF,3,{0x98,81,04}}, //powersetting
    {0x00,1,{0x00}}, //3//laneselect
    {0x6C,1,{0x15}}, //SetVCOREvoltage=1.5V
    {0x6E,1,{0x2A}}, //di_pwr_reg=0forpowermode2A//VGH=14.65clamp15V
    {0x6F,1,{0x35}}, //regvcl+pumpingratioVGH=3.5xVGL=-2.5x
    {0x3A,1,{0xA4}}, 
    {0x8D,1,{0x18}}, //VGLclamp-11V
    {0x87,1,{0xBA}}, 
    {0x26,1,{0x76}}, 
    {0xB2,1,{0xD1}}, 
    ...
    {0xFF,3,{0x98,81,01}}, 
    {0x22,1,{0x0A}}, //scan forward
    {0x31,1,{0x00}}, //Zig-ZaginversionType3
    //{0x53,1,{0x23}}, //VCOM1
    //{0x55,1,{0x50}}, //VCOM2
    {0x50,1,{0xA6}}, //VREG1OUT4.7
    {0x51,1,{0xA1}}, //VREG2OUT-4.7
    {0x60,1,{0x18}}, //SDT

    {0xA0,1,{0x00}}, //VP255GammaP
    {0xA1,1,{0x14}}, //VP251
    {0xA2,1,{0x23}}, //VP247
    {0xA3,1,{0x10}}, //VP243
    {0xA4,1,{0x16}}, //VP239
...
static unsigned int lcm_compare_id(void)
{
...
#ifdef BUILD_LK
    LCM_DBG(" ILI9881 hlt LK read id=0x%x, id1=0x%x, id2=0x%x",id, id_high,id_low);
#else
    LCM_DBG(" ILI9881 hlt LK read id=0x%x, id1=0x%x, id2=0x%x",id, id_high,id_low);
#endif 
    ...
    {
        LCM_DBG("it is ili9881c_v3740_hd720_dsi_vdo_hlt");
        return 1;
    }
    return 0;
}

LCM_DRIVER ili9881c_v3740_hd720_dsi_vdo_hlt_lcm_drv = 
{
    .name           = "ili9881c_v3740_hd720_dsi_vdo_hlt",
