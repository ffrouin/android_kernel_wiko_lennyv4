...
#define MAX_VOLTAGE (500)     // zhoulidong  add for lcm detect
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.horizontal_backporch                = 80;//15;
    params->dsi.horizontal_frontporch                = 100;//6;
    params->dsi.horizontal_active_pixel                = FRAME_WIDTH;
        ...
        params->dsi.PLL_CLOCK= 286; //245; //234;
