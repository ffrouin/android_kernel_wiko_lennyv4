...
static struct LCM_setting_table lcm_initialization_setting[] =
{
	...
	{0xC3,1,{0X02}},
	{0xC4,2,{0x00,0x64}},
	{0xC7,9,{0x00,0x01,0x32,0x05,0x65,0x2B,0x12,0xA5,0xA5}},

	{0xC8,38,{0x7F,0x69,0x50,0x3B,0x38,0x2B,0x31,0x1C,0x38,0x3A,0x3D,0x61,0x56,0x67,0x60,0x68,0x62,0x5B,0x4E,
		        0x7F,0x69,0x50,0x3B,0x38,0x2B,0x31,0x1C,0x38,0x3A,0x3D,0x61,0x56,0x67,0x60,0x68,0x62,0x5B,0x4E}},
...
static unsigned int rgk_lcm_compare_id(void)
{
    ...
    {
    #ifdef BUILD_LK
    printf("[adc_uboot hsd]: get data error\n");
   #else
	 printk("[adc_uboot hsd]: get data error\n");
  #endif
    return 0;
    ...
    #ifdef BUILD_LK
     printf("[adc_uboot hsd]: lcm_vol= %d\n",lcm_vol);
   #else
     printk("[adc_uboot hsd]: lcm_vol= %d\n",lcm_vol);
  #endif
...
LCM_DRIVER jd9161_wvga_dsi_vdo_hsd_hlt_lcm_drv = 
{
    .name			= "jd9161_wvga_dsi_vdo_hsd_hlt",
