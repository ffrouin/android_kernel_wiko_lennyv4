...
#define MIN_VOLTAGE (1350)     // zhoulidong  add for lcm detect
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.horizontal_backporch                = 20;//15;
...
LCM_DRIVER ili9881c_hd3800_dsi_vdo_3lanes_coe_lcm_drv =
{
        .name            = "ili9881c_hd3800_dsi_vdo_3lanes_coe",
